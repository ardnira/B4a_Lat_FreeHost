...
if (RapidSub.canDelegate("application_error")) { return free.hostQuuu.starter.remoteMe.runUserSub(false, "starter","application_error", _error, _stacktrace);}
...
if (RapidSub.canDelegate("service_create")) { return free.hostQuuu.starter.remoteMe.runUserSub(false, "starter","service_create");}
...
if (RapidSub.canDelegate("service_destroy")) { return free.hostQuuu.starter.remoteMe.runUserSub(false, "starter","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return free.hostQuuu.starter.remoteMe.runUserSub(false, "starter","service_start", _startingintent);}
...
if (RapidSub.canDelegate("service_taskremoved")) { return free.hostQuuu.starter.remoteMe.runUserSub(false, "starter","service_taskremoved");}
